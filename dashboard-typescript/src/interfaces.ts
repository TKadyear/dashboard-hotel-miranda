...
//TODO Change all the logic with old data estructure and then update the docs
export interface employee {
  ...
  photo: string;
  job_start_date: strDate;
  role: "Manager" | "Recepcionist" | "Room Service";
  duties: string;
  state: boolean;
}
...
export interface IRoom {
  ...
  discount: number;
  photos: Array<string>;
  bedType: "Double bed" | "Single Bed" | "Suite" | "Double Superior"
  number: number;
  description: string;
